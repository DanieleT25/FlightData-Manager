...
const (
	...
	UserService_CheckUserExistence_FullMethodName = "/user.UserService/CheckUserExistence"
)
...
type UserServiceClient interface {
	...
	CheckUserExistence(ctx context.Context, in *UserExistenceRequest, opts ...grpc.CallOption) (*UserExistenceResponse, error)
}
...
func (c *userServiceClient) CheckUserExistence(ctx context.Context, in *UserExistenceRequest, opts ...grpc.CallOption) (*UserExistenceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserExistenceResponse)
	err := c.cc.Invoke(ctx, UserService_CheckUserExistence_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	CheckUserExistence(context.Context, *UserExistenceRequest) (*UserExistenceResponse, error)
...
func (UnimplementedUserServiceServer) CheckUserExistence(context.Context, *UserExistenceRequest) (*UserExistenceResponse, error) {
...
func _UserService_CheckUserExistence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_CheckUserExistence_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).CheckUserExistence(ctx, req.(*UserExistenceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
